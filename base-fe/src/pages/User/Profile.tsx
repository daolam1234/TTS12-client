        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className=" gap-8 px-8 py-10 bg-white rounded-xl flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
                ...
                <div className="flex flex-col gap-3 ">
                    <div><span className="font-semibold">Họ và tên:</span> <span className="text-gray-700">Nguyễn Văn A</span></div>
                    <div><span className="font-semibold">Tuổi:</span> <span className="text-gray-700">22</span></div>
                    <div><span className="font-semibold">Giới tính:</span> <span className="text-gray-700">Nam</span></div>
                    <div><span className="font-semibold">Email:</span> <span className="text-gray-700">Lam12@gmail.com</span></div>
                </div>
            </div>
