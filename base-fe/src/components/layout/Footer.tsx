export default function Footer() {
    return (
        <div>
            <footer className="bg-gray-100  px-20 py-10 text-sm ">
                <div className="grid grid-cols-1 md:grid-cols-4 max-sm:gap-10">
                    <div className="flex flex-col gap-2">
                        <span className="text-3xl font-bold py-3 ">TRỢ GIÚP</span>
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-3xl font-bold py-3">LIÊN KẾT</span>
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-3xl font-bold py-3">THÔNG TIN LIÊN HỆ</span>
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-3xl font-bold py-3">MẠNG XÃ HỘI</span>
